# LLM Pipeline — "Dispatch office: reads the call, tags it, routes it to the right desk"

> Classify → triage orchestration, structured output, routing

**Paths:** `app/agent/pipeline.py, app/agent/classify.py`
